  ...
  if (!option.data || !option.data.m) {
    ...
    if (nowPage.length) {
      ...
      if (nowPage && nowPage.__route__) {
        ...
        // console.log(nowPage.__route__)
      }
    }
  }
  // console.log('现在地址:' + url)
...
util.getTotalPage = function (that, moduleName) {
  util.request({
    url: 'entry/wxapp/GetTotalPage',
    data: {
      table: that.data.fileName
    },
    success: function (e) {
      try {
        // console.log('total page')
        // console.log(e)
        that.data.totalpage = e.data.data
        util.getData(that, moduleName)
        // getData(that, moduleName)
      } catch (e) {
        console.error('success')
        console.error(e)
      }
...
util.footer = function ($this) {
  ...
  for (let i in tabBar['list']) {
    ...
    // console.log(tabBar['list'][i]['pageUrl'])
  }
